...
const ScheduleCatalogue_1 = require("./ScheduleCatalogue");
...
ScheduleCatalogue_1.ScheduleCatalogue.hasOne(Interview_1.Interview, { foreignKey: 'scheduleCatalogueId', as: 'interview', onDelete: 'CASCADE', hooks: true });
Interview_1.Interview.belongsTo(ScheduleCatalogue_1.ScheduleCatalogue, { foreignKey: 'scheduleCatalogueId', as: 'selectedSchedule' });
// User <-> Interview (1:N)
User_1.User.hasMany(Interview_1.Interview, { foreignKey: 'applicantId', as: 'interviews', onDelete: 'CASCADE', hooks: true });
Interview_1.Interview.belongsTo(User_1.User, { foreignKey: 'applicantId', as: 'applicant' });
