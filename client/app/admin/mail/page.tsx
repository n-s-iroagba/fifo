                    ...
                    <section className="bg-white p-6 rounded-2xl border border-blue-100 shadow-sm">
                        ...
                        <div className="space-y-2">
                            {[
                                ...
                                {
                                    title: 'Payment Instructions (USDT TRC-20)',
                                    subject: 'Instructions: How to Make Payment using USDT TRC-20 (TRON)',
                                    body: '<p>Dear [Insert Username],</p><p>Thank you for confirming your payment plan. Please find the instructions below to complete your payment using USDT on the TRC-20 (TRON) network.</p><h3><strong>Payment Details:</strong></h3><ul><li><strong>Currency:</strong> USDT (Tether)</li><li><strong>Network:</strong> TRC-20 (TRON) - <em>Important: Do not use ERC-20 or any other network, or your funds will be lost.</em></li><li><strong>Wallet Address:</strong> [Insert Wallet Address]</li><li><strong>Amount:</strong> [Insert USDT Amount]</li></ul><h3><strong>Steps to Send:</strong></h3><ol><li>Open your cryptocurrency exchange or wallet (e.g., Binance, Bybit, Trust Wallet, Ledger).</li><li>Select <strong>Withdraw</strong> or <strong>Send</strong> for <strong>USDT</strong>.</li><li>Paste the <strong>Wallet Address</strong> provided above.</li><li>Select the network exactly as <strong>TRC-20 (TRON)</strong>.</li><li>Enter the exact amount and confirm the transaction.</li></ol><p>Once completed, please reply to this email with a screenshot of your successful transaction or the Transaction Hash (TxID) so our finance team can verify and approve your payment.</p><p>Yours sincerely,<br />Blue Collar Recruitment / Aveling Support.</p>'
                                },
                                {
