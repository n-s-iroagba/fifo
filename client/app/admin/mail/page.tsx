                        ...
                        <div className="space-y-2">
                            {[
                                ...
                                },
                                {
                                    ...
                                    body: '<p>Dear [Insert Username],</p><p>To proceed with your required certifications, please complete your financial responsibility under the Ticket Sponsorship program.</p><p>Please confirm if you will be making half payments on your total ticket bundle or full payment at a 10% discount.</p><p>Please reply to this email to confirm your payment structure.</p><p>Yours sincerely,<br />Blue Collar Recruitment.</p>'
                                },
                                {
                                    title: 'Payment Instructions',
                                    subject: 'Instructions: How to Make Payment',
                                    body: '<p>Dear [Insert Username],</p><p>Thank you for confirming your payment plan. Please find the instructions below to complete your payment.</p><h3><strong>Payment Details:</strong></h3><ul><li><strong>Account / Reference:</strong> [Insert Payment Details]</li><li><strong>Amount:</strong> [Insert Amount]</li></ul><p>Once completed, please reply to this email with a screenshot of your successful transaction or proof of payment so our finance team can verify and approve your payment.</p><p>Yours sincerely,<br />Blue Collar Recruitment / Aveling Support.</p>'
                                },
                                {
