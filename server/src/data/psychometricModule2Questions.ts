export const psychometricModule2Questions = [
    ...
    },
    {
        ...
        options: [
            ...
            'To verify your training outcomes, application details, and suitability.',
    ...
    },
    {
        ...
        options: [
            ...
            'You must pick up your tickets from a local post office.',
            'Your physical tickets/certifications are delivered to your specified address anywhere in the globe.',
            'You are given a discount voucher.'
        ],
        correctOptionIndex: 2,
        weight: 1
    },
