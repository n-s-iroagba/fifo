...
exports.migratePaymentMilestone = migratePaymentMilestone;
 ...
 */
async function migratePaymentMilestone() {
    console.log('--- Initializing Payment Milestone Migration ---');
    try {
        await database_1.sequelize.query('ALTER TABLE users ADD COLUMN deposit_paid TINYINT(1) NOT NULL DEFAULT 0;');
    ...
    try {
        await database_1.sequelize.query('ALTER TABLE users ADD COLUMN deposit_paid_at DATETIME DEFAULT NULL;');
    ...
    try {
        await database_1.sequelize.query('ALTER TABLE users ADD COLUMN full_balance_paid TINYINT(1) NOT NULL DEFAULT 0;');
    ...
    try {
        await database_1.sequelize.query('ALTER TABLE tickets ADD COLUMN ticket_sequence_number INT DEFAULT NULL;');
