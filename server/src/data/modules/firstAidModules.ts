export const firstAidModules = [
    ...
    },
    {
        ...
        contentType: 'TEXT',
        contentUrl: 'local-content',
        content: 'Safe operation of an Automated External Defibrillator (AED) on adults and children, including pad placement and clearing the casualty before shock delivery. Learn the IMIST-AMBO format for handing over the casualty to arriving paramedics.',
    },
    {
        title: 'Module 3: Medical Emergencies — Bleeding, Shock, Anaphylaxis & Asthma',
        durationMinutes: 45,
        sequenceOrder: 3,
        contentType: 'TEXT',
        contentUrl: 'local-content',
    ...
    {
        title: 'Module 4: Environmental & Trauma Emergencies (Snakebite, Burns, Fractures)',
        durationMinutes: 45,
        sequenceOrder: 4,
        contentType: 'TEXT',
        contentUrl: 'local-content',
