...
function SponsorshipBadge({ status }: { status: string }) {
    const map: Record<string, { label: string; cls: string }> = {
        ...
        applied: { label: 'Sponsored – LMS Access Granted', cls: 'bg-blue-100 text-blue-800 border-blue-200' },
        approved: { label: 'Sponsored – LMS Access Granted', cls: 'bg-blue-100 text-blue-800 border-blue-200' },
